...
import { TouchInputHandler } from "./touchinput.js";
// import { TransitionManager } from "./transition.js";
export class Program {
    constructor(canvasWidth, canvasHeight, canvasParent) {
        this.timeSum = 0.0;
        this.oldTime = 0.0;
        this.initialized = false;
        this.onloadEvent = undefined;
        this.canvas = new Canvas(canvasWidth, canvasHeight, canvasParent);
        ...
        new TouchInputHandler(this.input);
    }
    loop(ts) {
